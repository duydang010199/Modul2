    ...
    <div class="header_middel">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-3">
                <div class="logo">
                    <a href="index.html"><img src="/image-load/logo123.jpg" alt="" style="
    height: 100px;
"></a>
                </div>
            </div>
            <div class="col-lg-9 col-md-9">
                <div class="header_right_info">
                    <div class="search_bar">
                        <form action="/product">
                            <input placeholder="Search..." type="text" name="search" id="myInput" value="${search}">
                            <button type="submit" type="get"><i class="fa fa-search"></i></button>
                        </form>
                    </div>
            ...
            <div class="col-12">
                <div class="main_menu_inner">
                    <div class="main_menu d-none d-lg-block">
                        <nav>
                            <ul>
                                <li class="active"><a href="product">Home</a>
                                </li>
